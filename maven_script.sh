...
sleep 5
sudo scp -i /home/ec2-user/Java_Projects/Build_Server.pem /home/ec2-user/Java_Projects/lagotech-web-app/target/lagotech-web-app.war ec2-user@54.196.98.197:/opt/tomcat9/webapps
